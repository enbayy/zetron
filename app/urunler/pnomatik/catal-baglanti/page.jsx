...
export default function CatalBaglanti() {
  const catalBaglantiSeries = [
    {
      name: "Klipsli Çatal Bağlantı",
      category: "Çatal Bağlantı",
      slug: "klipsli-catal-baglanti",
    },
    {
      name: "Sekmanlı Çatal Bağlantı",
      category: "Çatal Bağlantı",
      slug: "sekmanli-catal-baglanti",
    },
  ];
  ...
  const relatedProducts = [
    {
      ...
      href: "/urunler/pnomatik/iso-baglanti-sistemleri",
    },
    {
        ...
        >
          ...
          >
            ...
            <p className="text-lg mb-6 text-red-100">
              Çatal Bağlantı hakkında detaylı teknik bilgi ve fiyatlandırma için
          ...
          {/* Çatal Bağlantı Series Cards */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold mb-8 text-gray-800">
              Çatal Bağlantı Serileri
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {catalBaglantiSeries.map((catal, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  <Link href={`/urunler/pnomatik/catal-baglanti/${catal.slug}`}>
