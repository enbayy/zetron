...
export default function Kampanalar() {
  const kampanaSeries = [
    {
      name: "0K, 1K, 2K Kampana Serisi",
      category: "Kampanalar",
      slug: "0k-1k-2k-kampana-serisi",
    },
    {
      name: "Kavi Kare Kampana Serisi",
      category: "Kampanalar",
      slug: "kavi-kare-kampana-serisi",
    },
    {
      name: "3K Kampana Serisi",
      category: "Kampanalar",
      slug: "3k-kampana-serisi",
    },
    {
      name: "Yuvarlak Kampana Serisi",
      category: "Kampanalar",
      slug: "yuvarlak-kampana-serisi",
    },
  ];
        ...
        >
          ...
          >
            ...
            <p className="text-lg mb-6 text-red-100">
              Kampanalar hakkında detaylı teknik bilgi ve fiyatlandırma için lütfen
          ...
          {/* Kampana Series Cards */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold mb-8 text-gray-800">
              Kampana Serileri
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {kampanaSeries.map((kampana, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  <Link href={`/urunler/hidrolik/kampanalar/${kampana.slug}`}>
