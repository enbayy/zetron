...
export default function HavaTahliyeSiboplari() {
  ...
  const relatedProducts = [
    {
      ...
      href: "/urunler/degirmen/sklon-ustu-klepe-serisi",
    },
    {
      name: "Filtre Kapağı",
        ...
        >
          ...
          >
            ...
            <p className="text-lg mb-6 text-red-100">
              Hava Tahliye Sibopları hakkında detaylı teknik bilgi ve
