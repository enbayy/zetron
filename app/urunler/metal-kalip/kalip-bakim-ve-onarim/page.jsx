...
export default function KalipBakimVeOnarim() {
  const relatedProducts = [
    {
      name: "Metal Kalıp Tasarımı",
      description: "Profesyonel metal kalıp tasarım hizmetleri",
      href: "/urunler/metal-kalip/metal-kalip-tasarimi",
    },
    {
      name: "Kalıp Üretimi",
        ...
        >
          ...
          >
            ...
            <p className="text-lg mb-6 text-red-100">
              Kalıp Bakım ve Onarım hakkında detaylı teknik bilgi ve fiyatlandırma
